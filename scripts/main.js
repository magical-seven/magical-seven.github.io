...
myImage.onclick = function(){
    ...
    if(Mysrc === '/Astudy/project_html/images/firework.jpeg'){
        // alert('hello');
        myImage.setAttribute('src','/Astudy/project_html/images/firework2.jpeg');
    }
    else{
        myImage.setAttribute('src','/Astudy/project_html/images/firework.jpeg');
    }
